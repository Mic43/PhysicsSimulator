...
module CollisionDetection =
    ...
    let private detectBoxBoxCollision (boxCollider1:Box) body1 (boxCollider2:Box) (body2:RigidBody) : CollisionData option =
            ...
            let result =
                (match separationAxis with
                 | { Origin = origin
                     Reference = reference
                     Incident = incident
                     NormalFromReference = normal } when origin = Faces1 || origin = Faces2 ->
